...
static class HighScoreController
{
	...
	public static void DrawHighScores()
	{
		...
		SwinGame.DrawText("   High Scores - Least Shots Fired  ", Color.White, GameResources.GameFont("Courier"), SCORES_LEFT, SCORES_HEADING);
		...
		for (i = 0; i <= _Scores.Count - 1; i++) {
			...
			if (i < 9) {
				SwinGame.DrawText(" " + (a) + ":   " + s.Name + "   " + s.Value, Color.White, GameResources.GameFont("Courier"), SCORES_LEFT, SCORES_TOP + i * SCORE_GAP);
			} else {
				SwinGame.DrawText(a + ":   " + s.Name + "   " + s.Value, Color.White, GameResources.GameFont("Courier"), SCORES_LEFT, SCORES_TOP + i * SCORE_GAP);
			}
            a = (a - 1);
